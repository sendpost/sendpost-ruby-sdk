...
module Sendpost
  class IPPoolsApi
    ...
    # @param ippool_id [Integer] The ID of the IPPool to delete
    # @param [Hash] opts the optional parameters
    ...
    # @param ippool_id [Integer] The ID of the IPPool whose information you want to retrieve
    # @param [Hash] opts the optional parameters
    # @return [IPPool]
    ...
    # @param ippool_id [Integer] The ID of the IPPool to update
    # @param [Hash] opts the optional parameters
    # @return [IPPool]
