...
module Sendpost
  class IPApi
    ...
    # @param ip_id [Integer] The ID of the IP resource to delete
    # @param [Hash] opts the optional parameters
    ...
    # @param ip_id [Integer] The ID of the IP resource to retrieve
    # @param [Hash] opts the optional parameters
    # @return [IP]
    ...
    # @param ip_id [Integer] The ID of the IP resource to update
    # @param [Hash] opts the optional parameters
    # @return [IP]
