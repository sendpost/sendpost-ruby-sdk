...
module Sendpost
  class SubAccountApi
    ...
    # @param create_sub_account_request [CreateSubAccountRequest] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(SubAccount, Integer, Hash)>] SubAccount data, response status code and response headers
    def create_sub_account_with_http_info(create_sub_account_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: SubAccountApi.create_sub_account ...'
      end
      ...
      if @api_client.config.client_side_validation && create_sub_account_request.nil?
        fail ArgumentError, "Missing the required parameter 'create_sub_account_request' when calling SubAccountApi.create_sub_account"
      end
      # resource path
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'SubAccount'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['accountAuth']

      new_options = opts.merge(
        :operation => :"SubAccountApi.create_sub_account",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SubAccountApi#create_sub_account\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # @param subaccount_id [Integer] The ID of the sub-account to delete.
    # @param [Hash] opts the optional parameters
    # @return [DeleteSubAccountResponse]
    def delete_sub_account(subaccount_id, opts = {})
      data, _status_code, _headers = delete_sub_account_with_http_info(subaccount_id, opts)
      data
    end
    ...
    # @param subaccount_id [Integer] The ID of the sub-account to delete.
    # @param [Hash] opts the optional parameters
    # @return [Array<(DeleteSubAccountResponse, Integer, Hash)>] DeleteSubAccountResponse data, response status code and response headers
    def delete_sub_account_with_http_info(subaccount_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: SubAccountApi.delete_sub_account ...'
      end
      # verify the required parameter 'subaccount_id' is set
      if @api_client.config.client_side_validation && subaccount_id.nil?
        fail ArgumentError, "Missing the required parameter 'subaccount_id' when calling SubAccountApi.delete_sub_account"
      end
      # resource path
      local_var_path = '/account/subaccount/{subaccount_id}'.sub('{' + 'subaccount_id' + '}', CGI.escape(subaccount_id.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'DeleteSubAccountResponse'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['accountAuth']

      new_options = opts.merge(
        :operation => :"SubAccountApi.delete_sub_account",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SubAccountApi#delete_sub_account\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [String] :search Case-insensitive search against the sub-account name.
    # @return [Array<SubAccount>]
    def get_all_sub_accounts(opts = {})
      data, _status_code, _headers = get_all_sub_accounts_with_http_info(opts)
      data
    end
    ...
    # @option opts [Integer] :offset Number of initial records to skip.
    # @option opts [String] :search Case-insensitive search against the sub-account name.
    # @return [Array<(Array<SubAccount>, Integer, Hash)>] Array<SubAccount> data, response status code and response headers
    def get_all_sub_accounts_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: SubAccountApi.get_all_sub_accounts ...'
      end
      # resource path
      local_var_path = '/account/subaccount/'
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'Array<SubAccount>'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['accountAuth']

      new_options = opts.merge(
        :operation => :"SubAccountApi.get_all_sub_accounts",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SubAccountApi#get_all_sub_accounts\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param subaccount_id [Integer] The ID of the sub-account to retrieve.
    # @param [Hash] opts the optional parameters
    # @return [SubAccount]
    def get_sub_account(subaccount_id, opts = {})
      data, _status_code, _headers = get_sub_account_with_http_info(subaccount_id, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(SubAccount, Integer, Hash)>] SubAccount data, response status code and response headers
    def get_sub_account_with_http_info(subaccount_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: SubAccountApi.get_sub_account ...'
      end
      # verify the required parameter 'subaccount_id' is set
      if @api_client.config.client_side_validation && subaccount_id.nil?
        fail ArgumentError, "Missing the required parameter 'subaccount_id' when calling SubAccountApi.get_sub_account"
      end
      # resource path
      local_var_path = '/account/subaccount/{subaccount_id}'.sub('{' + 'subaccount_id' + '}', CGI.escape(subaccount_id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"SubAccountApi.get_sub_account",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SubAccountApi#get_sub_account\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param update_sub_account [UpdateSubAccount] 
    # @param subaccount_id [Integer] The ID of the sub-account to update.
    # @param [Hash] opts the optional parameters
    # @return [SubAccount]
    def update_sub_account(update_sub_account, subaccount_id, opts = {})
      data, _status_code, _headers = update_sub_account_with_http_info(update_sub_account, subaccount_id, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(SubAccount, Integer, Hash)>] SubAccount data, response status code and response headers
    def update_sub_account_with_http_info(update_sub_account, subaccount_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: SubAccountApi.update_sub_account ...'
      end
      # verify the required parameter 'update_sub_account' is set
      if @api_client.config.client_side_validation && update_sub_account.nil?
        fail ArgumentError, "Missing the required parameter 'update_sub_account' when calling SubAccountApi.update_sub_account"
      end
      # verify the required parameter 'subaccount_id' is set
      if @api_client.config.client_side_validation && subaccount_id.nil?
        fail ArgumentError, "Missing the required parameter 'subaccount_id' when calling SubAccountApi.update_sub_account"
      end
      # resource path
      local_var_path = '/account/subaccount/{subaccount_id}'.sub('{' + 'subaccount_id' + '}', CGI.escape(subaccount_id.to_s))
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(update_sub_account)
      ...
      new_options = opts.merge(
        :operation => :"SubAccountApi.update_sub_account",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SubAccountApi#update_sub_account\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
