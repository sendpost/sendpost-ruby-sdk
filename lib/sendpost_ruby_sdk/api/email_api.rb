...
module Sendpost
  class EmailApi
    ...
    # @param email_message_object [EmailMessageObject] Email message details
    # @param [Hash] opts the optional parameters
    # @return [Array<EmailResponse>]
    def send_email(email_message_object, opts = {})
      data, _status_code, _headers = send_email_with_http_info(email_message_object, opts)
      data
    end
    ...
    def send_email_with_http_info(email_message_object, opts = {})
      ...
      if @api_client.config.client_side_validation && email_message_object.nil?
        fail ArgumentError, "Missing the required parameter 'email_message_object' when calling EmailApi.send_email"
      end
      # resource path
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(email_message_object)
    ...
    # @param email_message_with_template [EmailMessageWithTemplate] Email message details with template information
    # @param [Hash] opts the optional parameters
    # @return [Array<EmailResponse>]
    def send_email_with_template(email_message_with_template, opts = {})
      data, _status_code, _headers = send_email_with_template_with_http_info(email_message_with_template, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(Array<EmailResponse>, Integer, Hash)>] Array<EmailResponse> data, response status code and response headers
    def send_email_with_template_with_http_info(email_message_with_template, opts = {})
      if @api_client.config.debugging
      ...
      if @api_client.config.client_side_validation && email_message_with_template.nil?
        fail ArgumentError, "Missing the required parameter 'email_message_with_template' when calling EmailApi.send_email_with_template"
      end
      # resource path
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(email_message_with_template)
