...
module Sendpost
  class DomainApi
    ...
    # @option opts [String] :search Case insensitive search against domain names
    # @return [Array<Domain>]
    ...
    def subaccount_domain_domain_id_delete(domain_id, opts = {})
      data, _status_code, _headers = subaccount_domain_domain_id_delete_with_http_info(domain_id, opts)
      data
    end
    ...
    def subaccount_domain_domain_id_delete_with_http_info(domain_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: DomainApi.subaccount_domain_domain_id_delete ...'
      end
      # verify the required parameter 'domain_id' is set
      if @api_client.config.client_side_validation && domain_id.nil?
        fail ArgumentError, "Missing the required parameter 'domain_id' when calling DomainApi.subaccount_domain_domain_id_delete"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"DomainApi.subaccount_domain_domain_id_delete",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DomainApi#subaccount_domain_domain_id_delete\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Domain]
    def subaccount_domain_domain_id_get(domain_id, opts = {})
      data, _status_code, _headers = subaccount_domain_domain_id_get_with_http_info(domain_id, opts)
      data
    end
    ...
    def subaccount_domain_domain_id_get_with_http_info(domain_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: DomainApi.subaccount_domain_domain_id_get ...'
      end
      # verify the required parameter 'domain_id' is set
      if @api_client.config.client_side_validation && domain_id.nil?
        fail ArgumentError, "Missing the required parameter 'domain_id' when calling DomainApi.subaccount_domain_domain_id_get"
      end
      # resource path
      local_var_path = '/subaccount/domain/{domain_id}'.sub('{' + 'domain_id' + '}', CGI.escape(domain_id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"DomainApi.subaccount_domain_domain_id_get",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DomainApi#subaccount_domain_domain_id_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Domain]
    def subaccount_domain_post(create_domain_request, opts = {})
      data, _status_code, _headers = subaccount_domain_post_with_http_info(create_domain_request, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(Domain, Integer, Hash)>] Domain data, response status code and response headers
    def subaccount_domain_post_with_http_info(create_domain_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: DomainApi.subaccount_domain_post ...'
      end
      ...
      if @api_client.config.client_side_validation && create_domain_request.nil?
        fail ArgumentError, "Missing the required parameter 'create_domain_request' when calling DomainApi.subaccount_domain_post"
      end
      # resource path
      local_var_path = '/subaccount/domain'
      ...
      new_options = opts.merge(
        :operation => :"DomainApi.subaccount_domain_post",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DomainApi#subaccount_domain_post\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
