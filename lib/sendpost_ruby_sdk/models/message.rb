...
module Sendpost
  class Message
    ...
    attr_accessor :account_ip_pool_id
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'account_ip_pool_id')
        self.account_ip_pool_id = attributes[:'account_ip_pool_id']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          ip_id == o.ip_id &&
          account_ip_pool_id == o.account_ip_pool_id &&
    ...
    def hash
      [message_id, account_id, sub_account_id, ip_id, account_ip_pool_id, public_ip, local_ip, email_type, submitted_at, from, reply_to, to, header_to, header_cc, header_bcc, attachments, groups, ip_pool, headers, custom_fields, subject, pre_text, html_body, text_body, amp_body, track_opens, track_clicks, attempt, webhook_endpoint, mx_records].hash
    end
