  ...
  class AutoWarmupPlan
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Sendpost::AutoWarmupPlan` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Sendpost::AutoWarmupPlan`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'gmail_warmup_plan')
        self.gmail_warmup_plan = attributes[:'gmail_warmup_plan']
      end

      if attributes.key?(:'yahoo_warmup_plan')
        self.yahoo_warmup_plan = attributes[:'yahoo_warmup_plan']
      end

      if attributes.key?(:'aol_warmup_plan')
        self.aol_warmup_plan = attributes[:'aol_warmup_plan']
      end

      if attributes.key?(:'microsoft_warmup_plan')
        self.microsoft_warmup_plan = attributes[:'microsoft_warmup_plan']
      end

      if attributes.key?(:'comcast_warmup_plan')
        self.comcast_warmup_plan = attributes[:'comcast_warmup_plan']
      end

      if attributes.key?(:'yandex_warmup_plan')
        self.yandex_warmup_plan = attributes[:'yandex_warmup_plan']
      end

      if attributes.key?(:'gmx_warmup_plan')
        self.gmx_warmup_plan = attributes[:'gmx_warmup_plan']
      end

      if attributes.key?(:'mailru_warmup_plan')
        self.mailru_warmup_plan = attributes[:'mailru_warmup_plan']
      end

      if attributes.key?(:'icloud_warmup_plan')
        self.icloud_warmup_plan = attributes[:'icloud_warmup_plan']
      end

      if attributes.key?(:'zoho_warmup_plan')
        self.zoho_warmup_plan = attributes[:'zoho_warmup_plan']
      end

      if attributes.key?(:'qq_warmup_plan')
        self.qq_warmup_plan = attributes[:'qq_warmup_plan']
      end

      if attributes.key?(:'default_warmup_plan')
        self.default_warmup_plan = attributes[:'default_warmup_plan']
      end

      if attributes.key?(:'att_warmup_plan')
        self.att_warmup_plan = attributes[:'att_warmup_plan']
      end

      if attributes.key?(:'office365_warmup_plan')
        self.office365_warmup_plan = attributes[:'office365_warmup_plan']
      end

      if attributes.key?(:'googleworkspace_warmup_plan')
        self.googleworkspace_warmup_plan = attributes[:'googleworkspace_warmup_plan']
      end

      if attributes.key?(:'proofpoint_warmup_plan')
        self.proofpoint_warmup_plan = attributes[:'proofpoint_warmup_plan']
      end

      if attributes.key?(:'mimecast_warmup_plan')
        self.mimecast_warmup_plan = attributes[:'mimecast_warmup_plan']
      end

      if attributes.key?(:'barracuda_warmup_plan')
        self.barracuda_warmup_plan = attributes[:'barracuda_warmup_plan']
      end

      if attributes.key?(:'ciscoironport_warmup_plan')
        self.ciscoironport_warmup_plan = attributes[:'ciscoironport_warmup_plan']
      end

      if attributes.key?(:'rackspace_warmup_plan')
        self.rackspace_warmup_plan = attributes[:'rackspace_warmup_plan']
      end

      if attributes.key?(:'zohobusiness_warmup_plan')
        self.zohobusiness_warmup_plan = attributes[:'zohobusiness_warmup_plan']
      end

      if attributes.key?(:'amazonworkmail_warmup_plan')
        self.amazonworkmail_warmup_plan = attributes[:'amazonworkmail_warmup_plan']
      end

      if attributes.key?(:'symantec_warmup_plan')
        self.symantec_warmup_plan = attributes[:'symantec_warmup_plan']
      end

      if attributes.key?(:'fortinet_warmup_plan')
        self.fortinet_warmup_plan = attributes[:'fortinet_warmup_plan']
      end

      if attributes.key?(:'sophos_warmup_plan')
        self.sophos_warmup_plan = attributes[:'sophos_warmup_plan']
      end

      if attributes.key?(:'trendmicro_warmup_plan')
        self.trendmicro_warmup_plan = attributes[:'trendmicro_warmup_plan']
      end

      if attributes.key?(:'checkpoint_warmup_plan')
        self.checkpoint_warmup_plan = attributes[:'checkpoint_warmup_plan']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          id == o.id &&
          name == o.name &&
          gmail_warmup_plan == o.gmail_warmup_plan &&
          yahoo_warmup_plan == o.yahoo_warmup_plan &&
          aol_warmup_plan == o.aol_warmup_plan &&
          microsoft_warmup_plan == o.microsoft_warmup_plan &&
          comcast_warmup_plan == o.comcast_warmup_plan &&
          yandex_warmup_plan == o.yandex_warmup_plan &&
          gmx_warmup_plan == o.gmx_warmup_plan &&
          mailru_warmup_plan == o.mailru_warmup_plan &&
          icloud_warmup_plan == o.icloud_warmup_plan &&
          zoho_warmup_plan == o.zoho_warmup_plan &&
          qq_warmup_plan == o.qq_warmup_plan &&
          default_warmup_plan == o.default_warmup_plan &&
          att_warmup_plan == o.att_warmup_plan &&
          office365_warmup_plan == o.office365_warmup_plan &&
          googleworkspace_warmup_plan == o.googleworkspace_warmup_plan &&
          proofpoint_warmup_plan == o.proofpoint_warmup_plan &&
          mimecast_warmup_plan == o.mimecast_warmup_plan &&
          barracuda_warmup_plan == o.barracuda_warmup_plan &&
          ciscoironport_warmup_plan == o.ciscoironport_warmup_plan &&
          rackspace_warmup_plan == o.rackspace_warmup_plan &&
          zohobusiness_warmup_plan == o.zohobusiness_warmup_plan &&
          amazonworkmail_warmup_plan == o.amazonworkmail_warmup_plan &&
          symantec_warmup_plan == o.symantec_warmup_plan &&
          fortinet_warmup_plan == o.fortinet_warmup_plan &&
          sophos_warmup_plan == o.sophos_warmup_plan &&
          trendmicro_warmup_plan == o.trendmicro_warmup_plan &&
          checkpoint_warmup_plan == o.checkpoint_warmup_plan &&
          created == o.created &&
          updated == o.updated &&
    ...
    def hash
      [id, name, gmail_warmup_plan, yahoo_warmup_plan, aol_warmup_plan, microsoft_warmup_plan, comcast_warmup_plan, yandex_warmup_plan, gmx_warmup_plan, mailru_warmup_plan, icloud_warmup_plan, zoho_warmup_plan, qq_warmup_plan, default_warmup_plan, att_warmup_plan, office365_warmup_plan, googleworkspace_warmup_plan, proofpoint_warmup_plan, mimecast_warmup_plan, barracuda_warmup_plan, ciscoironport_warmup_plan, rackspace_warmup_plan, zohobusiness_warmup_plan, amazonworkmail_warmup_plan, symantec_warmup_plan, fortinet_warmup_plan, sophos_warmup_plan, trendmicro_warmup_plan, checkpoint_warmup_plan, created, updated, warmup_interval].hash
    end
