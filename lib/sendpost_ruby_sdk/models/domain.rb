  ...
  class Domain
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Sendpost::Domain` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Sendpost::Domain`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'dkim_config')
        self.dkim_config = attributes[:'dkim_config']
      end
      ...
      if attributes.key?(:'track_verified')
        self.track_verified = attributes[:'track_verified']
      end
      ...
      if attributes.key?(:'domain_registered_date')
        self.domain_registered_date = attributes[:'domain_registered_date']
      end
      ...
      if attributes.key?(:'gpt_verified')
        self.gpt_verified = attributes[:'gpt_verified']
      end

      if attributes.key?(:'gpt')
        self.gpt = attributes[:'gpt']
      end

      if attributes.key?(:'dmarc_failure_reason')
        self.dmarc_failure_reason = attributes[:'dmarc_failure_reason']
      end

      if attributes.key?(:'dkim_failure_reason')
        self.dkim_failure_reason = attributes[:'dkim_failure_reason']
      end

      if attributes.key?(:'track_failure_reason')
        self.track_failure_reason = attributes[:'track_failure_reason']
      end

      if attributes.key?(:'return_path_failure_reason')
        self.return_path_failure_reason = attributes[:'return_path_failure_reason']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          verified == o.verified &&
          domain_registered_date == o.domain_registered_date &&
          created == o.created &&
          gpt_verified == o.gpt_verified &&
          gpt == o.gpt &&
          dmarc_failure_reason == o.dmarc_failure_reason &&
          dkim_failure_reason == o.dkim_failure_reason &&
          track_failure_reason == o.track_failure_reason &&
          return_path_failure_reason == o.return_path_failure_reason
    end
