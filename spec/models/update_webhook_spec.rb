...
# Unit tests for Sendpost::UpdateWebhook
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Sendpost::UpdateWebhook do
  let(:instance) { Sendpost::UpdateWebhook.new }

  describe 'test an instance of UpdateWebhook' do
    it 'should create an instance of UpdateWebhook' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Sendpost::UpdateWebhook)
    end
  end
