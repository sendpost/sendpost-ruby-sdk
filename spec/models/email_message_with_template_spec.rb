...
# Unit tests for Sendpost::EmailMessageWithTemplate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Sendpost::EmailMessageWithTemplate do
  let(:instance) { Sendpost::EmailMessageWithTemplate.new }

  describe 'test an instance of EmailMessageWithTemplate' do
    it 'should create an instance of EmailMessageWithTemplate' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Sendpost::EmailMessageWithTemplate)
    end
  end
