...
# Unit tests for Sendpost::CreateWebhookRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Sendpost::CreateWebhookRequest do
  let(:instance) { Sendpost::CreateWebhookRequest.new }

  describe 'test an instance of CreateWebhookRequest' do
    it 'should create an instance of CreateWebhookRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Sendpost::CreateWebhookRequest)
    end
  end
  ...
  describe 'test attribute "smtp_dropped"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "unique_open"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "unique_click"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
