...
# Unit tests for Sendpost::EmailMessageObject
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Sendpost::EmailMessageObject do
  let(:instance) { Sendpost::EmailMessageObject.new }

  describe 'test an instance of EmailMessageObject' do
    it 'should create an instance of EmailMessageObject' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Sendpost::EmailMessageObject)
    end
  end
