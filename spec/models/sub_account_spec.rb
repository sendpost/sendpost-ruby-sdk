...
# Unit tests for Sendpost::SubAccount
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Sendpost::SubAccount do
  let(:instance) { Sendpost::SubAccount.new }

  describe 'test an instance of SubAccount' do
    it 'should create an instance of SubAccount' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Sendpost::SubAccount)
    end
  end
  ...
  describe 'test attribute "is_plus"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'test attribute "hb_exempt"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "generate_weekly_report"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
