...
# Unit tests for Sendpost::Message
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Sendpost::Message do
  let(:instance) { Sendpost::Message.new }

  describe 'test an instance of Message' do
    it 'should create an instance of Message' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Sendpost::Message)
    end
  end
  ...
  describe 'test attribute "account_ip_pool_id"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
